                        ...
                        <div class="col">
                            <form method="POST" action="/update-user">
                                ...
                                <div class="form-group">
                                    <label>ID</label>
                                    <input name="id" type="" class="form-control" value="{{ $users->id }}" readonly>
                                </div>
                                <div class="form-group">
                                    <label>Name</label>
                                    <input name="name" type="" class="form-control" placeholder="Enter name" value="{{ $users->name }}">
                                </div>
                                <div class="form-group">
                                    <label>Email Address</label>
                                    <input name="email" type="email" class="form-control" placeholder="Enter email" value="{{ $users->email }}">
                                </div>
                                <div class="form-group">
